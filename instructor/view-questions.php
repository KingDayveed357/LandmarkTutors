<?php  include_once 'head.php'; ?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Past Question /</span>View-questions </h4>
 ...
 ?>
            ...
            <h3 class="fw-semibold d-block mt-2"><?php echo $row['title']; ?></h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="courseId" id="courseId" value="<?php echo $row['questionsId'] ?>">
    ...
    <script>
var rating_data = 0;
var courseId = <?php echo json_encode($_GET['questionsId']); ?>;
