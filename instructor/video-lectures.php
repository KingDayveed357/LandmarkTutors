<?php  include_once 'head.php';
    ...
    if(isset($_GET['videoId'])){
      ...
      header('Location: video-lectures'); 
      } }  
?>
  ...
  <body>
    ...
    <?php  include_once 'sidebar.php';?>
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    ...
                                    <input
                                      ...
                                      id="nameWithTitle"
                                      class="form-control"
                                      placeholder="Enter amount for course"
                                      name="fee"
                                    />
                                  </div>
                                </div>
		...
		$sql= $conn->query(" SELECT * FROM `video-lectures` WHERE instructorId='$instructorId' ORDER BY id desc ");
		if($sql->num_rows>0){
