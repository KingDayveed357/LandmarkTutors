 ...
 <nav
     ...
     ?>  
    <img src="../assets/img/avatars/instructor-profile.jpg" alt class="w-px-40 h-5 rounded-circle" />
    <?php
 }else {
     ?> 
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            ...
                            <?php if (empty($row['user_img'])) {
     ?>  
    <img src="../assets/img/avatars/instructor-profile.jpg" alt class="w-px-40 h-auto rounded-circle" />
    <?php
 }else {
     ?> 
    <img src="<?php echo $row['user_img']; ?>" alt class="w-px-40 w-100  h-100  rounded-circle" />
