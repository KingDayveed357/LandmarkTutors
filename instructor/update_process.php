<?php   require_once './config.php';
  if(isset($_POST['update'])){
   ...
   $sql= $conn->query("UPDATE instructor SET name='$name', email='$email', lastName='$lastName', phone='$phone' WHERE instructorId='$instructorId' "); 
   if ($sql){
    ...
    $sql= $conn->query("UPDATE instructor SET user_img='$target_file' WHERE instructorId='$instructorId' "); 
    if ($sql){
      $status = '<div class="alert alert-success alert-dismissible" role="alert">
       Details Updated Successfuly
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
