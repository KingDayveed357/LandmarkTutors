...
include '../student/functions.php';
       if(isset($_POST['register_course'])){
        include_once 'course-process.php';
    } 
    ...
    if(isset($_GET['courseId'])){
      ...
      //? delete user account
      $sql=$conn->query("DELETE FROM `course-note` WHERE courseId='$courseId'");
      if ($sql) {
    ...
    <?php  include_once 'sidebar.php';?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
          <div class="col-lg-10 md-text-center ">
              <h4 class="fw-bold  py-3 mb-3 lg-mb-4"><span class="text-muted fw-light">Courses /</span>Lecture Note</h4>
              
              </div>
              <div class="col-lg-2 mb-4  md-text-right md-mb-0">
                        ...
                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <form id="formAuthentication" class="mb-3 " action="courses" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col mb-3">
              ...
              $sql= $conn->query(" SELECT * FROM `course-note` WHERE instructorId='$instructorId' ORDER BY id DESC ");
              if($sql->num_rows>0){
                    ...
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <a href="view-course.php?courseId=<?= $row['courseId']; ?>&status=view" class="btn btn-sm btn-primary px-3 " >View Course</a>
                            </div>
                        </div>
                        <div class="text-left">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a href="edit-note.php?id=<?= $row['courseId']; ?>&status=edit" class="dropdown-item" href="javascript:void(0);"
                              ><i class="bx bx-edit-alt me-1"></i> Edit</a
                            >
                            <a href="courses.php?courseId=<?php echo $row ['courseId']; ?>&status=delete" class="dropdown-item" href="javascript:void(0);"
...
function load_rating_data(courseId) {
    ...
    <span style="color:red;"> You have not uploaded any course-note!!</span>
    </h5>
    <?php } ?>
              <!-- Examples -->
