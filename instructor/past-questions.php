...
?>
  ...
  <body>
    ...
    <?php  include_once 'sidebar.php';?>
		...
		$sql= $conn->query(" SELECT * FROM `past-questions` WHERE instructorId='$instructorId'  ORDER BY id DESC  ");
		if($sql->num_rows>0){
...
function load_rating_data(courseId) {
    ...
    <span style="color:red;"> You have not uploaded any past-question!!</span>
    </h5>
    <?php } ?>
              <!-- Examples -->
            </div>
