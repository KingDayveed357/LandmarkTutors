<?php
include_once './instructor/config.php';

require 'vendor/autoload.php';


if (isset($_POST['instructor_resetPass'])) {
    $email = $_POST['email'];
    $check_email = mysqli_query($conn, "SELECT * FROM `instructor` WHERE email= '$email' ");
    ...
    if ($res > 0) {
      ...
      $_SESSION['reset_token']= $resetToken;
        ...
        // Example query: UPDATE instructor SET reset_token = '$resetToken', reset_token_expires = DATE_ADD(NOW(), INTERVAL 1 HOUR) WHERE email = '$email'
        $updateTokenQuery = "UPDATE instructor SET reset_token = '$resetToken', reset_token_expires = DATE_ADD(NOW(), INTERVAL 1 HOUR) WHERE email = '$email'";
        ...
        <body>
          <div class=\"container\">
            ...
            <a href=\"http://localhost/LandmarkTutors/instructor_reset-password.php?instructor_resetPass=$resetToken\" class=\"reset-button\">Reset Password</a>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="#" method="POST">
                ...
                <button name="instructor_resetPass" class="btn btn-primary d-grid w-100">Send Reset Link</button>
              </form>
