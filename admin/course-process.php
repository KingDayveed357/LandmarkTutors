...
//check for any error
    if($isError == false){
        ...
        if($sql->num_rows>0){
            ...
            $sql= $conn->query("INSERT INTO `course-note` SET courseId='$courseId', title='$title', introMsg='$introMsg', coursePic='$target_file', pdfFile='$pdf_file', tutor='$acctName', profile='$profil', date='$date', fee='$fee' "); 
                if ($sql) {
