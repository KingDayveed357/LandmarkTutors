...
?>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Courses /</span> View Notes </h4>
                ...
                <div class="col-md-">
                  ...
                  <div class="card-body">
                    <div class="row g-5"> 
                      ...
                      <div class="col-md-6">
                        <!-- <img class="card-img card-img-left img-fluid" style="height:300px" src="<?php echo $row['coursePic']; ?>" alt="Card image" /> -->
    ...
    <?php
     ...
     ?> 
     <!-- <input type="hidden" name="insId" value="<?php echo $row['insId'] ?>" > -->
            ...
            <h2 class="fw-semibold d-block mt-2"><?php echo $row['title']; ?></h2>
                        ...
                        <div class="flex-grow-1">
                          ...
                          <div class="row mt-4 ">
                            <div class="col-md-7 ">
                              <p class="card-text">
                              <a class="btn btn-primary btn-lg"  download="<?php echo $row['pdfFile']; ?>"  href="<?php echo $row['pdfFile']; ?>" > <span class="tf-icons bx bx-download"></span>&nbsp;Download Note</a>
                              </p>
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    // echo $conn->query("SELECT * FROM `course_reviews` WHERE courseId='$courseId'")
                      ...
                      aria-valuemax="100" ></div> </div>
                        ...
                        <!-- <div class="col-md-4   mt-4 md-mt-0 mb-2 md-mb-0">
...
$('#save_review').click(function () {
    ...
    <!-- <script src="submit_rating.js"></script> -->
