    ...
    <?php  include_once 'sidebar.php';?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
          <div class="col-md-10">
              <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Checkout /</span>Buy course-note</h4>
              </div>
              ...
              <div class="row">
                ...
                <div class="accordion-item card">
                      ...
                      <input type="hidden" id="courseId" value="<?php echo $row['courseId']; ?>" name="courseId">
                      <input type="hidden" id="course_category" value="<?php echo $row['course_category']; ?>" name="course_category">
                        ...
                        <input type="hidden" id="paymentMethod" value="Monnify" name="payment_method">
                        <div class="mb-3">
        ...
        console.log("Transaction was not successful");
         ...
         <div class= "accordion-item card">
                      ...
                      <input type="hidden" id="courseCategory" value="<?php echo $row['course_category']; ?>" name="course_category">
                        ...
                        <input type="hidden" id="payment_method" value="Paystack" name="payment_method">
                        <div class="mb-3">
