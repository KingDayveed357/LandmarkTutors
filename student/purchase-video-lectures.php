...
?>
  ...
  <body>
    ...
    <?php  include_once 'sidebar.php';?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
          <div class="col-md-10">
              <h4 class="fw-bold py-3 "><span class="text-muted fw-light">Checkout/</span>video-lectures</h4>
              ...
              <div class="row">
                ...
                <div class="accordion-item card">
                      ...
                      <input type="hidden" id="videoId" value="<?php echo $row['videoId']; ?>" name="videoId">
                      <input type="hidden" id="course_category" value="<?php echo $row['course_category']; ?>" name="course_category">
                        <input type="hidden" id="course_title" value="<?php echo $row['name']; ?>" name="course_title">
                        <input type="hidden" id="course_description" value="<?php echo $row['introMsg']; ?>" name="course_description">
                        <input type="hidden" id="videoPics" value="<?php echo $row['videoPic']; ?>" name="videoPic">
                        <input type="hidden" id="videoLinks" value="<?php echo $row['videoLink']; ?>" name="videoLink">
        ...
        function payWithMonnify() {
          ...
          let videoPics = document.getElementById("videoPics").value;  
          let videoLinks = document.getElementById("videoLinks").value;  
    ...
    if (response.status === 'SUCCESS') {
        ...
        console.log("Transaction was not successful");
                ...
                onClose: function (data) {
                    ...
                    <div class= "accordion-item card">
                      ...
                      <input type="hidden" id="courseCategory" value="<?php echo $row['course_category']; ?>" name="course_category">
                        <input type="hidden" id="courseTitle" value="<?php echo $row['name']; ?>" name="course_title">
                        <input type="hidden" id="courseDescription" value="<?php echo $row['introMsg']; ?>" name="course_description">
                        <input type="hidden" id="videoPic" value="<?php echo $row['videoPic']; ?>" name="videoPic">
                        <input type="hidden" id="videoLink" value="<?php echo $row['videoLink']; ?>" name="videoLink">
          ...
          let videoPic = document.getElementById("videoPic").value; 
      ...
      $.ajax({
                    ...
                    data: {
                      videoId: videoId,
                        ...
                        paymentReference:paymentReference,
                        payment_status:paymentStatus
                          // Add this line only when necessary
                    },
                });
    }
  });
  ...
  handler.openIframe();
                ...
                <div class=" mt-5">
                    ...
                    <div class="row">
                    <div class="col-md-2">
                    <img class="img-fluid " src="<?php echo $row['videoPic']; ?>" alt="">
                   </div>
