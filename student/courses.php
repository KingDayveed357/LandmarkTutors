    ...
    <?php  include_once 'sidebar.php';?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
          <div class="col-md-10">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Courses /</span>Lecture Note</h4>
         </div>    
</div>
                    ...
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <a href="purchase-lecture-notes.php?courseId=<?= $row['courseId']; ?>&status=buy" class="btn btn-sm btn-primary px-3 ">Buy Course</a>
