  ...
  <?php  include_once 'sidebar.php';?>
     ...
     ?>  
    <img
        src="../assets/img/avatars/student-profile.png"
        alt="user-avatar"
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <?php  if(isset($_GET['studentId']) ){
                        ...
                        ?> <script>
                         window.location.replace('./logout')</script>
                         <?php
                        } }
                     ...
                     ?>
                        ...
                        <input type="hidden" value="<?php echo $row["studentId"] ?>">
                        <button
                          type="button"
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            ...
                            <div class="mb-4  text-center" >
                              ...
                              <a href="profile.php?studentId=<?php echo $row['studentId'];?>&status=delete" class=" btn btn-danger">Yes, delete it</a>
